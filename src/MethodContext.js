...
export const obj = {
    ...
    subscribe() {
        this.bindCounter = this.counter.bind(this);
        EventEmitter.on.call(EventEmitter, 'click', this.bindCounter);
    },
    unsubscribe() {
        EventEmitter.off.call(EventEmitter, 'click', this.bindCounter);
    },
};
